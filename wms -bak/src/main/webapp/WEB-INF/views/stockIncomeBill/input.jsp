...
<body>
	...
	<s:form name="editForm" namespace="/"
		action="stockIncomeBill_saveOrUpdate.action" id="editForm">
		<div id="container">
			<div id="nav_links">
					...
					<tr>
						...
						<td class="ui_text_lt">
							<s:select list="#depots" listKey="id" listValue="name"
								name="stockIncomeBill.depot.id" cssClass="ui_select01" />
						</td>
					</tr>
										...
										<tr>
											...
											<td>
												<s:textfield tag="costPrice"
													name="stockIncomeBill.items.costPrice"
													cssClass="ui_input_txt04" />
											</td>
											<td>
												<s:textfield tag="number"
													name="stockIncomeBill.items.number"
													cssClass="ui_input_txt04" />
											</td>
											<td>
											...
											<td>
												<s:textfield tag="remark"
													name="stockIncomeBill.items.remark"
