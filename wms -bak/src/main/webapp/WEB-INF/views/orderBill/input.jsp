...
<body>
	...
	<s:form name="editForm" namespace="/" action="orderBill_saveOrUpdate"
		...
		<div id="container">
			<div id="nav_links">
				<span style="color: #1A5CC6;">采购订单管理编辑</span>
				<div id="page_close">
					<a>
			...
			<div class="ui_content">
				<table cellspacing="0" cellpadding="0" width="100%" align="left"
					...
					<tr>
						...
						<td class="ui_text_lt">
							<s:select name="orderBill.supplier.id" list="#suppliers"
								cssClass=".ui_select02" listKey="id" listValue="name" />
						</td>
					</tr>
					...
					<tr>
						...
						<td class="ui_text_lt">
							<s:textfield name="orderBill.vdate"
					...
					<s:if test="orderBill.id == null">
						<tr>
							<td></td>
							<td>
								<input type="button" value="添加明细save"
										...
										<tr>
											...
											<td>
												<s:textfield tag="costPrice"
													name="orderBill.items.costPrice" cssClass="ui_input_txt02" />
											</td>
											<td>
												<s:textfield tag="number" name="orderBill.items.number"
