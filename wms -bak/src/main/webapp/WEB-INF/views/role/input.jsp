			...
			<div class="ui_content">
				<table cellspacing="0" cellpadding="0" width="100%" align="left"
					...
					<tr>
						...
						<td class="ui_text_lt">
							<s:textfield name="r.name" class="ui_input_txt02" />
						</td>
					</tr>
					...
					<tr>
						...
						<td class="ui_text_lt">
							<s:textfield name="r.sn" class="ui_input_txt02" />
						</td>
					</tr>
					<tr>
								...
								<tr>
									<td>
										<s:select list="#permissions" listKey="id" listValue="name"
											name="" multiple="true"
											class="ui_multiselect01 allPermissions">
										</s:select>
									</td>
									<td align="center">
									...
									<td>
										<s:select list="r.permissions" listKey="id" listValue="name"
											name="r.permissions.id" multiple="true"
											class="ui_multiselect01 selectedPermissions">
										</s:select>
									</td>
								</tr>
							</table>
								...
								<tr>
									<td>
										<s:select list="#menus" listKey="id" listValue="name"
											name="" multiple="true"
											class="ui_multiselect01 allMenus">
										</s:select>
									</td>
									<td align="center">
									...
									<td>
										<s:select list="r.menus" listKey="id" listValue="name"
											name="r.menus.id" multiple="true"
											class="ui_multiselect01 selectedMenus">
										</s:select>
									</td>
								</tr>
							</table>
