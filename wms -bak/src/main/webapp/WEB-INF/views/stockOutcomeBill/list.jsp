...
<head>
    ...
    <title>PSS-stockOutcomeBill管理</title>
    <style>
        .alt td {
            ...
            <div class="ui_text_indent">
                <div id="box_border">
                    ...
                    <div id="box_center">
                        ...
                        <s:select name="qo.clientId" list="#clients" listKey="id"
                                  listValue="name" headerKey="-1" headerValue="所有客户"
                                  id="searchForm_qo_clientId" class="ui_select01"/>
                ...
                <table class="table" cellspacing="0" cellpadding="0" width="100%"
                    ...
                    <s:iterator value="#result.data">
                        <tr class="data_tr">
                            ...
                            <s:if test="status ==0">
                                <td>
                                    <s:url namespace="" action="stockOutcomeBill_audit"
                                           var="auditUrl">
                                    ...
                                    <s:url namespace="/" action="stockOutcomeBill_delete"
                                           var="deleteUrl">
                                        <s:param name="stockOutcomeBill.id" value="id"></s:param>
                                    </s:url>
