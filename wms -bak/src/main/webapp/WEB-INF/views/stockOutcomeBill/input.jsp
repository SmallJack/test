...
<body>
	...
	<s:form name="editForm" namespace="/"
		action="stockOutcomeBill_saveOrUpdate.action" id="editForm">
		<div id="container">
			<div id="nav_links">
				<span style="color: #1A5CC6;">stockOutcomeBill编辑</span>
				<div id="page_close">
					<a>
			...
			<div class="ui_content">
				<table cellspacing="0" cellpadding="0" width="100%" align="left"
					...
					<tr>
						...
						<td class="ui_text_lt">
							<s:select list="#depots" listKey="id" listValue="name"
								name="stockOutcomeBill.depot.id" cssClass="ui_select01" />
						</td>
					</tr>
					<tr>
						...
						<td class="ui_text_lt">
							<s:select list="#clients" listKey="id" listValue="name"
								name="stockOutcomeBill.client.id" cssClass="ui_select01" />
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td class="ui_text_rt" width="140">出库明细</td>
					</tr>
					<tr>
						<td></td>
						<td>
										...
										<tr>
											...
											<td>
												<s:textfield disabled="true" readonly="true"
													cssClass="ui_input_txt04" tag="name" />
											...
											<td>
												<s:textfield tag="salePrice"
													name="stockOutcomeBill.items.salePrice"
													cssClass="ui_input_txt04" />
											</td>
											<td>
												<s:textfield tag="number"
													name="stockOutcomeBill.items.number"
													cssClass="ui_input_txt04" />
											</td>
											<td>
											...
											<td>
												<s:textfield tag="remark"
													name="stockOutcomeBill.items.remark"
									...
									<s:else>
										<s:iterator value="stockOutcomeBill.items">
											<tr>
												...
												<td>
													<s:textfield tag="salePrice" name="salePrice"
														cssClass="ui_input_txt04" />
												</td>
												<td>
