...
<body>
	...
	<s:form name="editForm" namespace="/" action="student_saveOrUpdate" id="editForm">
		<div id="container">
			<div id="nav_links">
				<span style="color: #1A5CC6;">学生编辑</span>
				<div id="page_close">
					<a>
			...
			<div class="ui_content">
				<table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
					...
					<tr>
						...
						<td class="ui_text_lt">
							<s:textfield name="student.age" cssClass="ui_input_txt02"></s:textfield>
						</td>
					</tr>
					...
					<tr>
						...
						<td class="ui_text_lt">
							<s:textfield name="student.name" cssClass="ui_input_txt02"></s:textfield>
						</td>
					</tr>
					<tr>
						<td>&nbsp;</td>
